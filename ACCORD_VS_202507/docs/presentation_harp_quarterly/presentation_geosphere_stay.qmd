...
format:
  revealjs:
    ...
    chalkboard: true
    preview-links: auto
    footer: "ACCORD MQA Initiative - GeoSphere Stay 2025"
    fig-align: center
---
...
::: {.column width="50%"}
**Key Results:**
- Successfully implemented both methods in `harpSpatial`
- Validated using Austrian CLAEF 1km ensemble
- Tested on DINI and DMI radar data
- Analyzed convective vs orographic cases
- Demonstrated added value over traditional metrics
:::
::::

---

## The Double Penalty Problem {.smaller}

:::: {.columns}
::: {.column width="50%"}
**Traditional point-by-point verification suffers from:**

- **Location Error**: Forecast is penalized for placing feature in wrong location
- **Miss Error**: Forecast is penalized again for missing feature in correct location
- **Result**: Misleadingly low scores even with correct intensity/structure
:::
...
**Solution**: Spatial verification methods that account for displacement tolerance
:::
::::
...
:::: {.columns}
::: {.column width="50%"}
![INCAPlus observations](case_studies/geosphere/2025072815_convection_case/ob_accrr3h_202507281800_INCAPlus.png){width=80%}

![CLAEF 1km forecast](case_studies/geosphere/2025072815_convection_case/fc_accrr1h_202507281800_3_CLAEF00.png){width=80%}
:::
...
- Large agreement scales (~38 grid points) indicate low fine-scale predictability
:::
::::

---

## Convective Case: SLX Results {.smaller}

:::: {.columns}
::: {.column width="50%"}
![SLX overall scores](case_studies/geosphere/2025072815_convection_case/slx_overall_2025072815_3_accrr3h.png){width=90%}

![SLX components](case_studies/geosphere/2025072815_convection_case/slx_comps_2025072815_3_accrr3h.png){width=90%}
:::
...
## Key Benefits and Applications {.smaller}

:::: {.columns}
::: {.column width="50%"}
**SLX Score Benefits:**
- ✅ Extreme-focused verification
...
- Integration of agreement scales in main `harp` workflow
...
- ACCORD MQA operational deployment
...
3. **Demonstration** of added value over traditional metrics
4. **Analysis** of two contrasting meteorological scenarios
5. **Integration** within ACCORD MQA framework
:::

::: {.column width="50%"}
**Key Scientific Insights:**
- Spatial verification reveals error characteristics invisible to traditional methods
- Orographic vs convective events show fundamentally different predictability patterns
- Scale-dependent analysis essential for high-resolution model evaluation
- Ensemble spread-skill relationships quantifiable at local scales
:::
::::

**Impact**: These methods provide operational forecasters and researchers with powerful tools to understand and improve high-resolution weather prediction, particularly for extreme events where spatial accuracy is crucial.
...
:::: {.columns}
::: {.column width="50%"}
**GeoSphere Austria Team:**
- Polly Schmederer (supervision and guidance)
- Philipp Scheffknecht (technical support)
- All GeoSphere staff for hosting and collaboration

**ACCORD Community:**
- MQA initiative participants
- `harp` development team
- CLAEF ensemble system providers
:::

::: {.column width="50%"}
**Scientific Community:**
- Bent Hansen Sass (SLX method development)
- Suranjana Dey et al. (Agreement Scales method)
- Spatial verification research community

**Resources:**
- Computing facilities at GeoSphere
- CLAEF 1km ensemble data
- INCAPlus observation data
:::
::::

**Contact**: carlos.peralta@[institution] | carlos9917@github
